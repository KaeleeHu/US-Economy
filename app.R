...
cfm_cities <- read.csv("/Users/macbookair/Documents/2020.1/final_1/data/time_series_covid19_confirmed_US.csv")
dth_cities <- read.csv("/Users/macbookair/Documents/2020.1/final_1/data/time_series_covid19_deaths_US.csv")
mydata <- read.csv("/Users/macbookair/Documents/2020.1/final_1/data/daily.csv")
...
server <- function(input, output) { 
    ...
    output$cor1 <- renderText({ 
        ...
        n1 <- c(input$n)
        df<- merge(confirmed_US, stock_close_prizes, Date = intersect(names(confirmed_US), names(stock_close_prizes)),
                   Date.confirmeds_US = Date, Date.stock_close_prizes = Date)
